...
The `ontologics` package provides tools to build and work with an ontology (linked vocabulary) in a tidy workflow.

And ontology is ...

We currently use the FAO-caliper standard for ontologies (but other data structures might be supported in the future), with the following setup ... 
