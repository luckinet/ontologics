...
lulc <- new_class(
  new = "landcover", target = NA, description = "A good definition of landcover",
  ontology = lulc
) %>%
  new_class(
    new = "land-use", target = "landcover", description = "A good definition of land-use",
    ontology = .
  )
